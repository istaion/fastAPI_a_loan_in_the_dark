...
CONTAINER_NAME="fastapiloan"
ACR_NAME="vpoutotRegistry"
ACR_LOGIN_SERVER="vpoutotregistry.azurecr.io"
IMAGE_NAME="$ACR_LOGIN_SERVER/fastapiloan:latest"
PORT=80
...
az container create \
    ...
    --os-type $OS_TYPE \
    --environment-variables SECRET_KEY="$SECRET_KEY" ACCESS_TOKEN_EXPIRE_MINUTES="$ACCESS_TOKEN_EXPIRE_MINUTES" DB_NAME="$DB_NAME" DB_USER="$DB_USER" DB_PASSWORD="$DB_PASSWORD" DB_SERVER="$DB_SERVER"
